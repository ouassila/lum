...
public class C_DatasPrise extends HttpServlet {
...
protected void doGet(HttpServletRequest request,
	...
	protected void doPost(HttpServletRequest request,
		...
		System.out.println(" Insertion base de données de ");
		System.out.println(temperature +" "+ humidite +" "+ date +" "+ adresseMac);
		System.out.println(M_Data.getInstance().insertData(adresseMac, temperature, humidite, date));
		/*String temperature = request.getParameter("temperature");
		String humidite = request.getParameter("humidite");
